...
#include <vector>
#include "protobuf.h"
ReflectType reflectTypeInfo[84] = {
ReflectType::ofEnum(/* mine id */ ReflectTypeID::EnumReflectTypeID, /* name */ "ReflectTypeID", /* enum values */ std::move(std::vector<ReflectEnumValue>{   ReflectEnumValue("EnumReflectTypeID", 0),
   ...
   ReflectEnumValue("Char", 7),
   ReflectEnumValue("Double", 8),
   ReflectEnumValue("Int32", 9),
   ReflectEnumValue("Uint32", 10),
   ReflectEnumValue("Uint64", 11),
   ReflectEnumValue("Int", 12),
   ReflectEnumValue("UnsignedChar", 13),
   ReflectEnumValue("Float", 14),
   ReflectEnumValue("Bool", 15),
   ReflectEnumValue("String", 16),
   ReflectEnumValue("Int64", 17),
   ReflectEnumValue("Uint8", 18),
   ReflectEnumValue("VectorOfUint8", 19),
   ReflectEnumValue("EnumCpuFamily", 20),
   ReflectEnumValue("EnumOs", 21),
   ReflectEnumValue("EnumAuthenticationType", 22),
   ReflectEnumValue("ClassSystemInfo", 23),
   ReflectEnumValue("ClassLoginCredentials", 24),
   ReflectEnumValue("ClassClientResponseEncrypted", 25),
   ReflectEnumValue("OptionalOfString", 26),
   ReflectEnumValue("OptionalOfVectorOfUint8", 27),
   ReflectEnumValue("EnumProduct", 28),
   ReflectEnumValue("EnumPlatform", 29),
   ReflectEnumValue("EnumCryptosuite", 30),
   ReflectEnumValue("ClassLoginCryptoDiffieHellmanChallenge", 31),
   ReflectEnumValue("ClassLoginCryptoChallengeUnion", 32),
   ReflectEnumValue("ClassLoginCryptoDiffieHellmanHello", 33),
   ReflectEnumValue("ClassLoginCryptoHelloUnion", 34),
   ReflectEnumValue("ClassBuildInfo", 35),
   ReflectEnumValue("ClassFeatureSet", 36),
   ReflectEnumValue("ClassAPChallenge", 37),
   ReflectEnumValue("ClassAPResponseMessage", 38),
   ReflectEnumValue("ClassLoginCryptoDiffieHellmanResponse", 39),
   ReflectEnumValue("ClassLoginCryptoResponseUnion", 40),
   ReflectEnumValue("ClassCryptoResponseUnion", 41),
   ReflectEnumValue("ClassPoWResponseUnion", 42),
   ReflectEnumValue("ClassClientResponsePlaintext", 43),
   ReflectEnumValue("ClassClientHello", 44),
   ReflectEnumValue("OptionalOfClassLoginCryptoDiffieHellmanChallenge", 45),
   ReflectEnumValue("OptionalOfClassLoginCryptoDiffieHellmanHello", 46),
   ReflectEnumValue("OptionalOfBool", 47),
   ReflectEnumValue("OptionalOfClassAPChallenge", 48),
   ReflectEnumValue("OptionalOfClassLoginCryptoDiffieHellmanResponse", 49),
   ReflectEnumValue("VectorOfEnumCryptosuite", 50),
   ReflectEnumValue("OptionalOfClassFeatureSet", 51),
   ReflectEnumValue("ClassHeader", 52),
   ReflectEnumValue("EnumAudioFormat", 53),
   ReflectEnumValue("ClassAudioFile", 54),
   ReflectEnumValue("ClassRestriction", 55),
   ReflectEnumValue("ClassTrack", 56),
   ReflectEnumValue("ClassEpisode", 57),
   ReflectEnumValue("OptionalOfEnumAudioFormat", 58),
   ReflectEnumValue("OptionalOfInt32", 59),
   ReflectEnumValue("VectorOfClassRestriction", 60),
   ReflectEnumValue("VectorOfClassAudioFile", 61),
   ReflectEnumValue("VectorOfClassTrack", 62),
   ReflectEnumValue("EnumMessageType", 63),
   ReflectEnumValue("EnumPlayStatus", 64),
   ReflectEnumValue("EnumCapabilityType", 65),
   ReflectEnumValue("ClassTrackRef", 66),
   ReflectEnumValue("ClassState", 67),
   ReflectEnumValue("ClassCapability", 68),
   ReflectEnumValue("ClassDeviceState", 69),
   ReflectEnumValue("ClassFrame", 70),
   ReflectEnumValue("OptionalOfUint32", 71),
   ReflectEnumValue("OptionalOfEnumPlayStatus", 72),
   ReflectEnumValue("OptionalOfUint64", 73),
   ReflectEnumValue("VectorOfClassTrackRef", 74),
   ReflectEnumValue("OptionalOfEnumCapabilityType", 75),
   ReflectEnumValue("VectorOfInt64", 76),
   ReflectEnumValue("VectorOfString", 77),
   ReflectEnumValue("OptionalOfInt64", 78),
   ReflectEnumValue("VectorOfClassCapability", 79),
   ReflectEnumValue("OptionalOfEnumMessageType", 80),
   ReflectEnumValue("OptionalOfClassDeviceState", 81),
   ReflectEnumValue("OptionalOfClassState", 82),
...
ReflectField( /* typeID */ ReflectTypeID::Int64, /* name */ "offset", /* offset */ offsetof(ReflectField, offset), /* protobuf tag */ 0),
...
ReflectField( /* typeID */ ReflectTypeID::Int64, /* name */ "size", /* offset */ offsetof(ReflectType, size), /* protobuf tag */ 0),
...
ReflectType::ofClass(
	/* mine type id */ ReflectTypeID::ClassRestriction, 
	/* name */ "Restriction", 
	/* fields */ std::move(std::vector<ReflectField>{ReflectField( /* typeID */ ReflectTypeID::OptionalOfString, /* name */ "countries_allowed", /* offset */ offsetof(Restriction, countries_allowed), /* protobuf tag */ 2),
ReflectField( /* typeID */ ReflectTypeID::OptionalOfString, /* name */ "countries_forbidden", /* offset */ offsetof(Restriction, countries_forbidden), /* protobuf tag */ 3),
}), 
	/* size */ sizeof(Restriction), 
	__reflectConstruct<Restriction>,
	__reflectDestruct<Restriction>),
ReflectType::ofClass(
...
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassRestriction, /* name */ "restriction", /* offset */ offsetof(Track, restriction), /* protobuf tag */ 11),
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassAudioFile, /* name */ "file", /* offset */ offsetof(Track, file), /* protobuf tag */ 12),
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassTrack, /* name */ "alternative", /* offset */ offsetof(Track, alternative), /* protobuf tag */ 13),
}), 
	/* size */ sizeof(Track), 
...
ReflectField( /* typeID */ ReflectTypeID::VectorOfClassAudioFile, /* name */ "audio", /* offset */ offsetof(Episode, audio), /* protobuf tag */ 12),
	...
	ReflectType::ofVector(
		/* mine typeId */ ReflectTypeID::VectorOfClassRestriction,
		/* inner type id */  ReflectTypeID::ClassRestriction,
		/* size */ sizeof(std::vector<Restriction>),
		VectorOperations{
			.push_back = __VectorManipulator<Restriction>::push_back,
			.at = __VectorManipulator<Restriction>::at,
			.size = __VectorManipulator<Restriction>::size,
			.emplace_back =  __VectorManipulator<Restriction>::emplace_back,
			.clear = __VectorManipulator<Restriction>::clear,
			.reserve = __VectorManipulator<Restriction>::reserve,
		},
		__reflectConstruct<std::vector<Restriction>>,
		__reflectDestruct<std::vector<Restriction>>
	)
	...
	ReflectType::ofVector(
		/* mine typeId */ ReflectTypeID::VectorOfClassTrack,
		/* inner type id */  ReflectTypeID::ClassTrack,
		/* size */ sizeof(std::vector<Track>),
		VectorOperations{
			.push_back = __VectorManipulator<Track>::push_back,
			.at = __VectorManipulator<Track>::at,
			.size = __VectorManipulator<Track>::size,
			.emplace_back =  __VectorManipulator<Track>::emplace_back,
			.clear = __VectorManipulator<Track>::clear,
			.reserve = __VectorManipulator<Track>::reserve,
		},
		__reflectConstruct<std::vector<Track>>,
		__reflectDestruct<std::vector<Track>>
	)
