...
void register_default_nvs(){
	...
	ESP_LOGD(TAG,"Registering default value for key %s, value %s", "enable_cspot", STR(CONFIG_CSPOT_SINK));
	config_set_default(NVS_TYPE_STR, "enable_cspot", STR(CONFIG_CSPOT_SINK), 0);
#endif	
